<ul class="Product">
    <li>
        <a href="<?php bloginfo('url') ?>/productos/luker-1906">
    ...
    <li>
        <a href="<?php bloginfo('url') ?>/productos/luker-cacao">
