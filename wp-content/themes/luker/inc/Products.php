...
<ul class="Product">
    <li>
        <a href="<?php bloginfo('url'); echo '/'.$url ?>/luker-1906">
    ...
    <li>
        <a href="<?php bloginfo('url'); echo '/'.$url ?>/luker-cacao">
    ...
    <li>
        <a href="<?php bloginfo('url'); echo '/'.$url ?>/luker-maracas">
